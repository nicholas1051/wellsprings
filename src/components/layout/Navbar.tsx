      ...
      <nav aria-label="Main" className="container-site flex h-16 items-center justify-between gap-4 sm:h-20">
        ...
        <div className="hidden items-center gap-1 lg:flex">
          ...
          <div className="ml-2 flex items-center gap-2">
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={cn("grid h-8 w-8 place-items-center rounded-full bg-brand-blue text-white transition-colors hover:bg-brand-blue-dark")}>
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={cn("grid h-8 w-8 place-items-center rounded-full bg-brand-blue text-white transition-colors hover:bg-brand-blue-dark")}>
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={cn("grid h-8 w-8 place-items-center rounded-full bg-brand-blue text-white transition-colors hover:bg-brand-blue-dark")}>
