...
export const location = {
  ...
  landmarks: [
    ...
    { id: "secretariat", name: "Oyo State Secretariat", distanceKm: 12.3, category: "government" as const, badge: "\u25A3", description: "Close to a major government and administrative destination in Oyo State." },
    { id: "palms", name: "The Palms Mall", distanceKm: 13, category: "shopping" as const, badge: "\u25A2", description: "A major shopping destination for retail, dining and everyday convenience." },
    ...
    { id: "jericho", name: "Jericho Mall", distanceKm: 5, category: "shopping" as const, badge: "\u25C7", description: "A nearby lifestyle and shopping destination for dining, retail and leisure." },
